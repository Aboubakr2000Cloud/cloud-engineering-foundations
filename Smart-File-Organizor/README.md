...
## Overview
This capstone project is a smart file organizer that automatically sorts messy folders into organized category structures using pattern matching and intelligent duplicate handling. It uses essential data structures (dictionaries, tuples, sets) and file I/O operations.
...
**Smart File Organizer Project Complete!** This project demonstrates mastery of Python data structures, file I/O, path operations, and professional CLI design—essential skills for automation and systems programming in cloud engineering.
