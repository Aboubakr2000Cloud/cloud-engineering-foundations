...
## Overview
This capstone project focuses on advanced bash scripting and automation through cron scheduling. It is a comprehensive website health monitoring system that automatically checks multiple websites, logs their status, detects issues, and generates daily summary reports—all running autonomously via cron jobs.
...
**Website-Health-Monitoring-System Project Complete!**
